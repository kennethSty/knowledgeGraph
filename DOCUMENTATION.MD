...
Considering, the connectivity of the graphs we make two observations. First, as expected the among the nodes with the highest betweenness centrality score are indeed not only medically related. Without assessing 
