...
## Evaluation
We evaluated three different pipeline configurations on 5 random pages out of the retrieved 10k Wikipedia pages. The small scale of this evaluation was partly due to the cost accompanied by OpenAI API calls, but also motivated to provide the opportunity for a qualitative analysis of a rather small graph. Therefore, in the following section, we reflect on the different generated graphs from different quantitative and qualitative angles, in order to improve our local and global understanding of the inner workings and challenges during construction. These multiple viewpoints per constructed graph consist of: 
