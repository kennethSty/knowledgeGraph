...
Furthermore, we demonstrate a model-based quantitative and qualitative evaluation strategy that can be extended to other comparable MGK construction tasks.
The insights gained from this study might be relevant for several application scenarios. On the one hand, our pipeline can be further developed to streamline the actual large-scale construction of MGKs for downstream tasks such as a Graph-Vector-Store for medical question-answering systems. On the other hand, our evaluation procedure might prove an interesting strategy for other MGK construction approaches, regardless of whether our construction strategy is pursued or not. 
