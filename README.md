...
- To reproduce the plots showcased in the report run the `kg_analysis_pipeB.py` script in the `analysis` directory for each generated graph by activating the corresponding DBMS and using the correct bolt URL to the DBMS that is activated. 
